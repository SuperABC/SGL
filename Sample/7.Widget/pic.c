...
void sgSetup() {
	...
	registerWidget(easyWidget(SG_LABEL, "label", 100, 100, 120, 40, "picture", NULL));
	registerWidget(easyWidget(SG_PIC, "pic", 100, 140, 0, 0, "source/pic.bmp", NULL));
	registerWidget(easyWidget(SG_CHECK, "check", 240, 100, 80, 20, "inverse", callback));
}
void sgLoop() {
